...
TRAINING_SCRIPTS = [
    PROJECT_ROOT / "scripts" / "experiments" / "04_train_models.py",
    PROJECT_ROOT / "scripts" / "pipeline" / "04_train_improved_models.py",
    PROJECT_ROOT / "scripts" / "experiments" / "04_train_advanced_models.py",
]
